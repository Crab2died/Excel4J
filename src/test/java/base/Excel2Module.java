...
public class Excel2Module extends BaseTest {


    @Test
    public void excel2Object() throws Exception {

        String path = TEMPLATE_PATH + "students_01.xlsx";
    ...
    public void excel2Object2() {
        ...
        String path = TEMPLATE_PATH + "students_02.xlsx";
        try {
    ...
    public void testReadExcel_XLS() throws Exception {
        String path = TEMPLATE_PATH + "StudentScore.xlsx";
